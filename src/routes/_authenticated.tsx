...
const CA_NAV_OWNER = [
  ...
  { to: "/ca/compliance-calendar", icon: CalendarClock, label: "Compliance Calendar" },
  { to: "/ca/vault", icon: FolderArchive, label: "Documents" },
  ...
  { to: "/ca/reports", icon: FileDown, label: "Client Documents & Data Prep" },
